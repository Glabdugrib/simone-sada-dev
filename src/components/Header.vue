<template>
  <header id="header">
    <nav class="navbar">
      <!-- Logo -->
      <div class="logo">
        <a href="/simone-sada-dev/#">S</a>
      </div>
      <!-- Nav links -->
      <div class="nav-list">
        <ol>
          <li class="disabled">
            <a href="/simone-sada-dev/simone-sada-dev/#about">{{ $t("nav.about") }}</a>
          </li>
          <li class="disabled">
            <a href="/simone-sada-dev/simone-sada-dev/#experience">{{ $t("nav.experience") }}</a>
          </li>
          <li>
            <a href="/simone-sada-dev/simone-sada-dev/#projects">{{ $t("nav.projects") }}</a>
          </li>
          <li>
            <a href="/simone-sada-dev/simone-sada-dev/#contacts">{{ $t("nav.contact") }}</a>
          </li>
      ...
      <div class="dropdown">
        ...
        <aside :class="[dropdownIsOpen ? 'open' : '', 'sidebar']">
          <ol>
            <li class="disabled">
              <a href="/simone-sada-dev/#about">{{ $t("nav.about") }}</a>
            </li>
            <li class="disabled">
              <a href="/simone-sada-dev/simone-sada-dev/#experience">{{ $t("nav.experience") }}</a>
            </li>
